<template>
  ...
  >
    <button
      class="cal-group cal-my-2 cal-flex cal-w-full cal-cursor-pointer cal-items-center cal-justify-center cal-rounded-md cal-bg-gray-100 cal-font-medium cal-outline-none cal-transition-all cal-duration-150 cal-ease-out focus:cal-outline-none focus:cal-ring-2 focus:cal-ring-theme-800 focus:cal-ring-opacity-50 dark:cal-border-theme-600 dark:cal-bg-theme-800"
      :class="[
        isSelected(event) ? 'cal-bg-accent-0 cal-text-white' : 'cal-bg-gray-100 cal-bg-theme-100 cal-text-gray-700 hover:cal-bg-gray-200 hover:cal-text-accent-0 hover:dark:cal-bg-theme-600',
