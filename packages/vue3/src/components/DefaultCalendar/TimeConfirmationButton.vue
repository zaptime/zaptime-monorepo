  ...
  <div>
    ...
    >
      <button
        ...
        :class="[
          isSelected(timeSlot)
            ? 'cal-bg-accent-base cal-text-white'
            : 'cal-bg-theme-100 cal-text-theme-700 hover:cal-bg-theme-200 hover:cal-text-accent-base hover:dark:cal-bg-theme-600',
    ...
    <div v-else class="w-full cal-flex cal-items-center cal-space-x-2">
      <button
        ...
        :class="[
          isSelected(timeSlot)
            ? 'cal-bg-accent-base cal-text-white'
            : 'cal-bg-theme-100 cal-text-theme-700 hover:cal-bg-theme-200 hover:cal-text-accent-base dark:cal-bg-theme-800 hover:dark:cal-bg-theme-600',
        ]"
