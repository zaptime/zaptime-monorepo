        ...
        <div v-if="state.timeSlots && state.timeSlots.length > 0 && !state.loading" class="cal-flex cal-h-full cal-flex-col cal-justify-between">
          <div>
            ...
            <div class="cal-pb-0.5 cal-pt-6">
              <p v-if="config.locale && config.locale.texts?.choosePreferredTime" class="cal-text-base cal-font-medium cal-tracking-tighter cal-text-theme-600 dark:cal-text-theme-200">
          ...
          <div v-if="!config.locale?.hideTimePreferences" class="cal-mt-5 cal-flex cal-items-center cal-space-x-2 cal-pb-4 sm:cal-mt-0">
          ...
          <div v-else class="cal-flex cal-flex-col cal-items-center cal-justify-center">
            <div class="cal-mt-48 cal-flex cal-h-full cal-items-center cal-justify-center">
              <div class="cal-flex cal-w-40 cal-flex-col cal-items-center cal-justify-center cal-rounded-2xl cal-px-7 cal-py-5 cal-text-theme-700 dark:cal-text-theme-200">
                ...
                <p v-if="config.locale && config.locale.texts?.chooseDate" class="cal-mt-2 cal-w-40 cal-text-center cal-text-theme-900 dark:cal-text-theme-200" v-html="config.locale.texts?.chooseDate"></p>
              </div>
            </div>
          </div>
        </div>
