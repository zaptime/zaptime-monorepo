<template>
  <div>
    <Transition
      enter-active-class="cal-duration-200 cal-transition-all cal-ease-out "
      enter-from-class="cal-opacity-0 -cal-translate-x-[1px]"
      enter-to-class="cal-opacity-100 cal-translate-x-0"
      leave-active-class="cal-duration-200 cal-ease-in"
