    ...
    >
      <div class="cal-flex cal-items-center cal-justify-center">
        <button
          ...
          :class="{
            'cal-bg-theme-100 cal-text-theme-700  cal-ring-theme-200 focus:cal-outline-none focus:cal-ring-2 dark:cal-bg-theme-800 dark:cal-text-theme-100 dark:hover:cal-text-theme-300':
              dayHasEvent(day) && !day.isPast && !isSelectedDay(day),
            'cal-cursor-default cal-text-theme-300 dark:cal-text-theme-300': (day.isPast && !day.isCurrentMonth) || (!dayHasEvent(day) && day.isCurrentMonth),
            ...
            'cal-pointer-events-none cal-text-theme-300 dark:cal-text-theme-300': day.isPast,
          }"
