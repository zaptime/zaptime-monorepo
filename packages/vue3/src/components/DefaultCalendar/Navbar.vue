<template>
  <div :class="[config.profileImage && !reservation ? '' : 'cal:pt-6']">
    <div v-if="!reservation">
      ...
      <div
        ...
        class="cal:w-full cal:text-center cal:text-theme-600 cal:dark:text-theme-200"
    ...
    <div
      ...
      class="cal:px-3"
    >
      <p class="cal:text-base cal:font-medium cal:tracking-tighter cal:text-theme-600 cal:dark:text-theme-200">{{ config.locale?.confirmationForm?.reschedulingEvent }}</p>

      <div
        v-if="reservation"
        class="cal:text-lg cal:font-semibold cal:tracking-tighter cal:text-theme-600 cal:dark:text-theme-200"
      >
  ...
  <div class="cal:flex cal:justify-between cal:py-4">
    <p class="cal:ml-3 cal:text-base cal:font-medium cal:text-theme-900 cal:dark:text-theme-200">{{ monthName }} {{ currentYear }}</p>
    <div class="cal:mr-1 cal:flex">
      ...
      >
        <svg
          class="cal:h-6 cal:w-6 cal:rotate-180 cal:text-accent-dark cal:hover:text-accent-base"
          width="24"
          height="24"
          viewBox="0 0 24 24"
          fill="none"
      ...
      >
        <svg
          class="cal:h-6 cal:w-6 cal:text-accent-dark cal:hover:text-accent-base"
          width="24"
          height="24"
          viewBox="0 0 24 24"
          fill="none"
