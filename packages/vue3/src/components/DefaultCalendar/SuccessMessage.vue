<template>
  <div
    ...
    class="cal:h-full cal:justify-center cal:rounded-xl cal:bg-white cal:px-0 cal:pb-20 cal:pt-24 cal:dark:bg-theme-900 cal:sm:px-6"
  ...
  >
    ...
    <h2 class="cal:mt-[24px] cal:text-center cal:font-semibold cal:text-theme-500 cal:dark:text-theme-100">
      {{ getFormattedDayInMonth(selectedTimeSlot.start) }}
    </h2>

    <h3 class="cal:mt-2 cal:text-center cal:text-2xl cal:font-semibold cal:leading-[36px] cal:text-theme-700 cal:dark:text-theme-300">
