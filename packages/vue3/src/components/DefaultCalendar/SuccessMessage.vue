<template>
  ...
  >
    ...
    <h2
      class="cal-mt-[24px] cal-text-center cal-font-semibold cal-text-theme-500 dark:cal-text-theme-100"
    >
      {{ getFormattedDayInMonth(selectedTimeSlot.start) }}
    </h2>

    <h3
      class="cal-mt-2 cal-text-center cal-text-2xl cal-font-semibold cal-leading-[36px] cal-text-theme-700 dark:cal-text-theme-300"
    >
