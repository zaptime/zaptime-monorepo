    ...
    <div v-if="!state.loading">
        ...
        <div class="cal-mt-2 cal-h-64 cal-overflow-y-auto cal-px-1">
          ...
          >
            <span
              class="cal-leading-4"
              :class="{
                'py-4 cal-text-theme-700 dark:cal-text-white':
                  isSelected(timeSlot),
      ...
      <div v-else class="cal-w-full">
        ...
        >
          ...
          >
            <div
              class="cal-flex cal-h-40 cal-w-40 cal-items-center cal-justify-center cal-rounded-2xl cal-px-5 dark:cal-text-theme-50"
            >
              <p
