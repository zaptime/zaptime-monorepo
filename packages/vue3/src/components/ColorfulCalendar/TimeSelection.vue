    ...
    <div v-if="!state.loading">
        ...
        <div class="cal-mt-2 cal-px-1 cal-overflow-y-auto cal-h-64">
          ...
          >
            <span
              class="cal-leading-4"
              :class="{
                'dark:cal-text-white py-4 cal-text-theme-700':
                  isSelected(event),
      ...
      <div class="cal-w-full" v-else>
        ...
        >
          ...
          >
            <div
              class="cal-px-5 cal-flex cal-items-center cal-justify-center cal-w-40 cal-h-40 dark:cal-text-theme-50 cal-rounded-2xl"
            >
              <p
