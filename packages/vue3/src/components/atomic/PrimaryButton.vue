<template>
  <button
    ...
    @click="$emit('click')"
  >
    <svg class="cal-mr-3 cal-h-5 cal-w-5 cal-animate-spin cal-text-white cal-ease-in" :class="[loading ? 'cal-inline-block' : 'cal-hidden']" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
