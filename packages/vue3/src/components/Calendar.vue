  ...
  <div class="cal-h-full cal-min-h-[360px]">
    ...
    >
      <div
        ...
        class="cal-h-full cal-w-[330px] sm:cal-w-[400px] cal-bg-white"
      ...
      <div
        v-else
        class="cal-flex cal-h-full cal-w-[841px] cal-bg-white"
        :class="[config.compact ? 'cal-rounded-l-xl' : 'cal-rounded-xl']"
      >
        <div
          :key="calendarView"
          class="cal-w-[330px] sm:cal-w-[400px] cal-px-[48px]"
          :style="{ backgroundColor: color }"
        >
          <Navbar />
        ...
        <div
          class="cal-border-l cal-border-gray-200"
          :style="{ backgroundColor: color2 }"
        >
          <TimeSelection v-if="!state.loading" />
        </div>
