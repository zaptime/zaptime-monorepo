<template>
  ...
  <div v-if="stripeConfig" class="cal-mt-6">
    <div class="cal-mt-3">
      ...
      <p
        class="cal-text-lg cal-font-medium cal-leading-[24px] cal-text-theme-700 dark:cal-text-theme-100"
      >
        {{ priceCurrency }}
      </p>
    </div>
    ...
    <Transition>
      <div
        v-if="
          showAllBillingDetails && config.locale?.confirmationForm?.payments
        "
      >
        <div class="">
          <TextInput
