...
export { SlotNoLongerAvailableError, RescheduleNotAllowedError } from "./api/api";
...
export { default as rescheduleNotAllowedText } from "./utils/rescheduleNotAllowedText";
