(function(exports) {
	...
	*/
	...
	const accountStatusMap = /* @__PURE__ */ new Map();
	const pendingCallbacks = /* @__PURE__ */ new Map();
	const fetchingTokens = /* @__PURE__ */ new Set();
	...
	*/
	...
	createModalStyles(false);
	createModalStyles(true);
	//#endregion
	...
	*/
	function isDarkMode() {
		...
		if (getComputedStyle(html).colorScheme === "dark") return true;
		return false;
	}
	/**
	...
	function createInlineButton(options) {
		...
		*/
		function applyButtonStyling(button) {
			applyStyles(button, mergeStyles(inlineButtonStyles.base, {
				backgroundColor: customButtonColor,
				color: customButtonTextColor
			}));
			button.innerHTML = "<span>" + customButtonText + "</span>";
